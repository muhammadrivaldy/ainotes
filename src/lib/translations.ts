  ...
  en: {
    ...
    features: {
      ...
      forgetThings: {
        ...
        description: "How many times have you forgotten someone's birthday, a password hint, or an important meeting detail? With AI Notes, just tell it once and retrieve it anytime through simple conversation.",
      },
      tooComplicated: {
  ...
  id: {
    ...
    features: {
      ...
      forgetThings: {
        ...
        description: "Berapa kali Anda lupa ulang tahun seseorang, petunjuk kata sandi, atau detail rapat penting? Dengan AI Notes, cukup beri tahu sekali dan ambil kapan saja melalui percakapan sederhana.",
      },
      tooComplicated: {
